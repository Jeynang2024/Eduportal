...
import { addAchivementData } from "../../../services/educatorService";
import Papa from "papaparse";
import './BehaviouralStyling.css'

const AddAchivementDataForm = () => {
  ...
  criteria: ['Academic', 'Competition', 'Behavioral']
    .map(category => {
    ...
    try {
      await addAchivementData(payload);
      toast.success("Achievement data added!");
    } catch {
      toast.error("Failed to add achievemnt data.");
    }
  };
...
export default AddAchivementDataForm;