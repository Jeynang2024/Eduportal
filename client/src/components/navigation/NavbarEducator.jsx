      ...
      <div className="relative">
        ...
        {dropdownOpen && (
          <div className="absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-lg border border-blue-100 z-50 animate-fade-in">
            ...
            <a href="/educator/profile" className="block px-4 py-2 text-blue-700 hover:bg-blue-50 transition-colors">Profile</a>
            <button className="w-full text-left px-4 py-2 text-red-600 hover:bg-red-50 transition-colors">Logout</button>
          </div>
        )}
      </div>
    </nav>
